...
[9] A. Johnston and D. Burnett, "WebRTC: APIs and RTCWEB Protocols of the HTML5 Real-Time Web," Digital Codex LLC, 3rd ed., 2014.

[10] I. Grigorik, "High Performance Browser Networking," O'Reilly Media, 2013. Available: https://hpbn.co/

[11] S. Loreto and S. Romano, "Real-Time Communication with WebRTC: Peer-to-Peer in the Browser," O'Reilly Media, 2014.

[12] M. Fowler, "Patterns of Enterprise Application Architecture," Addison-Wesley Professional, 2002.

[13] N. Nurseitov, M. Paulson, R. Reynolds, and C. Izurieta, "Comparison of JSON and XML Data Interchange Formats: A Case Study," in Proc. CAINE, 2009, pp. 157–162.

[14] T. Berners-Lee, R. Fielding, and L. Masinter, "Uniform Resource Identifier (URI): Generic Syntax," RFC 3986, IETF, 2005.

[15] R. Fielding, "Architectural Styles and the Design of Network-based Software Architectures," Ph.D. dissertation, Univ. of California, Irvine, 2000.

[16] A. Silberschatz, H. F. Korth, and S. Sudarshan, "Database System Concepts," 7th ed., McGraw-Hill, 2019.

[17] D. Flanagan, "JavaScript: The Definitive Guide," 7th ed., O'Reilly Media, 2020.

[18] M. Ubl and E. Labrecque, "Scalable and Modular Architecture for CSS," Available: https://smacss.com/, 2012.

[19] OWASP Foundation, "OWASP Top Ten Web Application Security Risks," Available: https://owasp.org/www-project-top-ten/, 2021.

[20] P. Saint-Andre, "Extensible Messaging and Presence Protocol (XMPP): Core," RFC 6120, IETF, 2011.

[21] V. Cerf and R. Kahn, "A Protocol for Packet Network Intercommunication," IEEE Transactions on Communications, vol. 22, no. 5, pp. 637–648, May 1974.

[22] bcrypt.js Contributors, "bcryptjs: Optimized bcrypt in JavaScript," Available: https://github.com/dcodeIO/bcrypt.js, 2023.
